...
public class EventController {
    ...
    public String getNextEvent(Model model) {
        ...
        LocalDate nextEventDate = eventInfo.getNextEventDate(
                eventInfo.getStartDate(),
                eventInfo.getRepeatInterval(),
    ...
    public String getEventsList(Model model) {
        Comparator<Event> comparator = Comparator.comparing(o -> o.getNextEventDate(
                o.getStartDate(),
                o.getRepeatInterval(),
                o.getRepeatOften())); // sort events by next event date
